...
class _BottombarState extends State<Bottombar> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _headingoptions = <Widget>[
      ...
      Text("Air Filter Monitoring", style: TextStyle(
          fontSize: 23,
          fontWeight: FontWeight.bold,
          color: Color(0xff042954)
        ),),
    ...
    switch (_selectedIndex) {
      case 0:
        bottomNavBarColor = Color.fromARGB(255, 216, 191, 216); // Light Purple // Home color
        break;
      case 1:
        bottomNavBarColor = Color.fromARGB(255, 173, 216, 230); // Solar Still color
        break;
      case 2:
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.filter_alt), label: "Air Filter"),
